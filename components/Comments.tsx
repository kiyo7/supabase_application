...
import { useQueryComments } from '../hooks/query/useQueryComments'
import { useSubscribeComments } from '../hooks/subscribe/useSubscribeComments'
...
export const CommentsMemo: React.FC<Props> = ({ postId }) => {
